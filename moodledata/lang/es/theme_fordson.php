...
/**
 * Strings for component 'theme_fordson', language 'es', branch 'MOODLE_34_STABLE'
 *
...
$string['activateonboth'] = 'Activar en Todas las páginas';
$string['activateoncoursepage'] = 'Activar en Página del curso';
$string['activateonhomepage'] = 'Activar en Página principal';
...
$string['adddrawermenu'] = 'Agregar elementos personalizados al Cajón de navegación';
$string['adddrawermenu_desc'] = 'Puedes agregar elementos personalizados al menú de navegación utilizando la siguiente sintaxis (idéntica a la utilizada en el menú personalizado en la configuración del tema).
<br>
Ejemplo:
<br>
Comunidad Moodle|http://moodle.org/support
<br>
Sitio Moodle|http://moodle.com';
...
$string['mycoursesinfodesc'] = 'Muestra una lista dinámica con los cursos en los que está matriculado el usuario en la barra de navegación superior.';
...
$string['setting_removecalendarnode'] = 'Eliminar "Calendario" del menú';
$string['setting_removecalendarnode_desc'] = 'Al activar esta opción se eliminará el elemento de menú "Calendario" del cajón de navegación de Boost.';
$string['setting_removedashboardnode'] = 'Eliminar "Área personal" del menú';
$string['setting_removedashboardnode_desc'] = 'Al activar esta opción se eliminará el elemento de menú "Área personal" del cajón de navegación de Boost.';
$string['setting_removehomenode'] = 'Eliminar "Inicio" del menú';
$string['setting_removehomenode_desc'] = 'Al activar esta opción se eliminará el elemento de menú "Página Principal" del cajón de navegación de Boost.';
$string['setting_removemycoursesnode'] = 'Eliminar "Mis cursos" del menú';
$string['setting_removemycoursesnode_desc'] = 'Al activar esta opción se eliminará el elemento de menú "Mis cursos" del cajón de navegación de Boost.';
$string['setting_removemycoursesnodeperformancehint'] = 'Ten en cuenta: Si habilitas esta opción y también has habilitado la opción <a href="/admin/search.php?query=navshowmycoursecategories"> navshowmycoursecategories </a>, se tarda más tiempo en quitar el nodo "Mis cursos" y debes considerar deshabilitar la opción navshowmycoursecategories.';
$string['setting_removenodesheading'] = 'Personalizar el Cajón de Navegación';
$string['setting_removenodesperformancehint'] = 'Técnicamente se hace estableciendo el atributo showinflatnavigation del elemento de menú a false. Por lo tanto, el nodo sólo estará oculto en el cajón de navegación, pero permanecerá en el árbol de navegación y podrá accederse por otras partes de Moodle.';
$string['setting_removeprivatefilesnode'] = 'Eliminar "Archivos privados" del menú';
$string['setting_removeprivatefilesnode_desc'] = 'Al activar esta opción se eliminará el elemento de menú "Ficheros privados" del cajón de navegación de Boost.';
$string['setting_removesecondhomenode'] = 'Eliminar la segunda aparición de "Página Principal" o "Área personal" del menú';
$string['setting_removesecondhomenode_desc'] = 'Al activar esta opción se eliminará el elemento "Página Principal" o "Área personal" del menú del cajón de navegación de Boost,  dependiendo de lo que el usuario eligió no ser su página de inicio.';
...
$string['showbacktotop'] = 'Mostrar el botón de Volver arriba';
$string['showbacktotop_desc'] = 'Desmarca esta opción para ocultar el botón Volver arriba en la parte inferior derecha de la página.';
...
$string['toggledrawermenu'] = 'Activar el cajón de navegación personalizado';
$string['toggledrawermenu_desc'] = 'Determina dónde se aplicarán estos ajustes.';
