...
/**
 * Strings for component 'reengagement', language 'es', branch 'MOODLE_34_STABLE'
 *
...
$string['reengagement:getnotifications'] = 'Recibir notificaciones cuando se completen reenganches';
