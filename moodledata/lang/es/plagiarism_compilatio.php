...
/**
 * Strings for component 'plagiarism_compilatio', language 'es', branch 'MOODLE_34_STABLE'
 *
...
$string['help_compilatio_languages_content'] = 'Los análisis de Compilatio pueden ser realizados en más de 40 idiomas (incluidos todos las lenguas latinas).<br/> El chino, el japonés, el árabe y el alfabeto cirílico todavía no son compatibles.';
...
$string['help_compilatio_thresholds_content'] = 'Se pueden definir los colores de los resultados en la configuración de cada tarea, en la sección "Plugin de detección de plagio Compilatio".<br/> Es posible elegir los umbrales que determinan el color de visualización de los grados de similitudes.';
