...
/**
 * Strings for component 'search_elastic', language 'es', branch 'MOODLE_34_STABLE'
 *
...
$string['fileindexsettings_desc'] = 'Configurar indexador de archivos para el motor de búsqueda de Elasticsearch';
$string['hostname'] = 'Nombre de servidor';
$string['hostname_desc'] = 'El FQDN del endpoint de Elasticsearch';
$string['index'] = 'Índice';
$string['index_desc'] = 'Nombre del índice donde se almacenarán los datos en el backend';
