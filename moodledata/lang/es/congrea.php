...
/**
 * Strings for component 'congrea', language 'es', branch 'MOODLE_31_STABLE'
 *
 * @package   congrea
...
$string['anyonepresenter_help'] = 'Si lo habilita cualquiera (incluyendo al estudiante) puede ser un presentador.';
...
$string['configactiontolocalrun'] = 'Si selecciona "Local", se requerirá SSL (https: //) para usar las funciones de compartir pantalla.';
$string['congrea:addinstance'] = 'Agregar un nuevo Congrea';
$string['congrea:dorecording'] = 'Guardar grabación';
...
$string['congrea:recordingupload'] = 'Subir archivo grabado';
$string['congreatiming'] = 'Calendario de clases virtuales: {$ a-> open} a {$ a-> close}';
$string['congrea:view'] = 'Ver Congrea';
$string['customsetting'] = 'Ajustes personalizados';
$string['disableAudio'] = 'Deshabilitar audio';
$string['disablespeaker'] = 'Silencio';
...
$string['joinroom'] = 'Unirse a la clase virtual';
$string['liverun'] = 'Online - Utilizar el servidor vidya.io';
$string['localrun'] = 'Local - Utilizar los archivos de Moodle';
